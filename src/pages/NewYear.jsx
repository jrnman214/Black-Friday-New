...
const NewYear = () => {
    ...
    return (
        <div className="page-wrapper new-year-theme">
            ...
            <section className="hero-section">
                <div className="content-container">
                    ...
                    <h1 className="main-headline animate-on-scroll fade-in-up">🎉 NEW YEAR SALE 🎆</h1>
                    <p className="sub-headline animate-on-scroll fade-in-up delay-100">Unlock your financial freedom in 2026! Get access to the ultimate Credit Repair & Funding Blueprint. This New Year exclusive offer ends soon. 🥂</p>

                    <div className="video-wrapper animate-on-scroll zoom-in delay-200">
                        <div style={{ position: 'relative', paddingBottom: '56.25%', height: 0, overflow: 'hidden' }}>
                            <video
                                src="/assets/New%20Years%20Sale.mp4"
                                controls
                                autoPlay
                                muted
                                loop
                    ...
                    <h2 className="section-headline animate-on-scroll fade-in-up delay-300">CHECK OUT THIS LIMITED TIME SALE</h2>
                    <p className="payment-note animate-on-scroll fade-in delay-300">New Year Payment plans available at checkout</p>
                </div>
            </section>
            ...
            <section className="copy-section">
                <div className="content-container text-left">
                    <h2 className="copy-headline">Introducing The 2026 New Year Sale Mentorship For Beginner & Advanced Entrepreneurs Looking to Leverage Credit To Build a 6-7 Figure Business.</h2>
                    ...
                    <div className="breakdown-grid">
                        <div className="breakdown-item animate-on-scroll fade-in-up">
                            <div className="item-header">
                                ...
                                <h3>Credit Expunge Administered by ME <span className="price-value">($2500 Value)</span></h3>
                            </div>
                        ...
                        <div className="breakdown-item animate-on-scroll fade-in-up">
                            <div className="item-header">
                                ...
                                <h3>Mindset <span className="price-value">($97 Value)</span></h3>
                            </div>
                        ...
                        <div className="breakdown-item animate-on-scroll fade-in-up">
                            <div className="item-header">
                                ...
                                <h3>Branding Your Business <span className="price-value">($197 Value)</span></h3>
                            </div>
                        ...
                        <div className="breakdown-item animate-on-scroll fade-in-up">
                            <div className="item-header">
                                ...
                                <h3>How To Start A Business <span className="price-value">($47 Value)</span></h3>
                            </div>
                        ...
                        <div className="breakdown-item animate-on-scroll fade-in-up">
                            <div className="item-header">
                                ...
                                <h3>Personal Credit <span className="price-value">($797 Value)</span></h3>
                            </div>
                        ...
                        <div className="breakdown-item animate-on-scroll fade-in-up">
                            <div className="item-header">
                                ...
                                <h3>Business Credit <span className="price-value">($997 Value)</span></h3>
                            </div>
                        ...
                        <div className="breakdown-item animate-on-scroll fade-in-up">
                            <div className="item-header">
                                ...
                                <h3>Tradelines <span className="price-value">($27 Value)</span></h3>
                            </div>
                        ...
                        <div className="breakdown-item animate-on-scroll fade-in-up">
                            <div className="item-header">
                                ...
                                <h3>Funding Structure <span className="price-value">($297 Value)</span></h3>
                            </div>
                        ...
                        <div className="breakdown-item animate-on-scroll fade-in-up">
                            <div className="item-header">
                                ...
                                <h3>Funding Secrets <span className="price-value">($1997 Value)</span></h3>
                            </div>
                        ...
                        <div className="breakdown-item animate-on-scroll fade-in-up">
                            <div className="item-header">
                                ...
                                <h3>Credit 2 Cash <span className="price-value">($497 Value)</span></h3>
                            </div>
                        ...
                        <div className="breakdown-item animate-on-scroll fade-in-up">
                            <div className="item-header">
                                ...
                                <h3>6 Figur Funding Business <span className="price-value">($4697 Value)</span></h3>
                            </div>
                        ...
                        <div className="breakdown-item animate-on-scroll fade-in-up">
                            <div className="item-header">
                                ...
                                <h3>Digital Product Mastery <span className="price-value">($497 Value)</span></h3>
                            </div>
                        ...
                        <div className="breakdown-item animate-on-scroll fade-in-up">
                            <div className="item-header">
                                ...
                                <h3>Affiliate Marketing <span className="price-value">($197 Value)</span></h3>
                            </div>
                    ...
                    <div className="breakdown-grid">
                        <div className="breakdown-item animate-on-scroll fade-in-up">
                            <div className="item-header">
                                ...
                                <h3>BONUS#1 Credit History Turbo Boost <span className="price-value">($297 Value)</span></h3>
                            </div>
                        ...
                        <div className="breakdown-item animate-on-scroll fade-in-up">
                            <div className="item-header">
                                ...
                                <h3>BONUS #2 1-On-1 Coaching Calls <span className="price-value">($397 Value)</span></h3>
                            </div>
                        ...
                        <div className="breakdown-item animate-on-scroll fade-in-up">
                            <div className="item-header">
                                ...
                                <h3>BONUS #3 $30K Funding <span className="price-value">($597 Value)</span></h3>
                            </div>
                        ...
                        <div className="breakdown-item animate-on-scroll fade-in-up">
                            <div className="item-header">
                                ...
                                <h3>BONUS #4 Passive Income Play <span className="price-value">($1,197 Value)</span></h3>
                            </div>
                        ...
                        <div className="breakdown-item animate-on-scroll fade-in-up">
                            <div className="item-header">
                                ...
                                <h3>BONUS #5 Lifetime Access ALL Courses <span className="price-value">($5,000 Value)</span></h3>
                            </div>
            ...
            <footer>
                <div className="content-container">
                    <p>&copy; 2026 6 Figur Funding. New Year, New Future. All rights reserved.</p>
                </div>
            </footer>
        </div>
    );
